...
import (
	...
	v1 "github.com/yourusername/microservices-protos/gen/order/v1"
	http "net/http"
	strings "strings"
)
...
func (UnimplementedOrderServiceHandler) CreateOrder(context.Context, *connect_go.Request[v1.CreateOrderRequest]) (*connect_go.Response[v1.CreateOrderResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("order.v1.OrderService.CreateOrder is not implemented"))
}
